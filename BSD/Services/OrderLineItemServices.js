const OrderLineItemModel = require('../Models/OrderLineItemsModel');
const Messages = require("../Helpers/Messages");
const logServices = require("./LogServices");
const Dbmodel = OrderLineItemModel;
const PrimaryKey = "orderLineItemId"


const OrderLineItemServices = {
...
module.exports = OrderLineItemServices;
